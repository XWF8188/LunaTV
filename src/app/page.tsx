  ...
  return (
    <PageLayout>
      ...
      <div className='overflow-visible -mt-6 md:mt-0 pb-32 md:pb-safe-bottom'>
        {/* 欢迎横幅 - 现代化升级 */}
        <div className='mb-6 relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 backdrop-blur-md shadow-2xl border border-white/20 group'>
          {/* 动态背景装饰 */}
          <div className='absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-black/10'></div>
          <div className='absolute -top-24 -right-24 w-48 h-48 bg-white/10 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-1000 ease-out'></div>
          <div className='absolute -bottom-24 -left-24 w-48 h-48 bg-purple-400/20 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-1000 ease-out delay-100'></div>

          <div className='relative z-10 p-5 sm:p-6'>
            <div className='relative z-10 flex items-center justify-between gap-4'>
              <div className='flex-1 min-w-0'>
                <h2 className='text-xl sm:text-2xl font-bold text-white mb-1.5 flex items-center gap-2 flex-wrap animate-fade-in-up'>
                  <span className='bg-clip-text text-transparent bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-200'>
                    {greeting}
                  </span>
                  {username && (
                ...
                <p className='text-sm sm:text-base text-white/95 font-medium animate-fade-in-up animate-delay-200'>
                  发现更多精彩影视内容
                </p>
              </div>
