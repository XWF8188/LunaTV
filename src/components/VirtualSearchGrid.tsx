      ...
      <div ref={containerRef} className='w-full'>
        ...
        {!isLoading && totalItemCount > 0 && (
          <div className='flex justify-center mt-8 py-8'>
            <div className='relative px-8 py-5 rounded-2xl bg-gradient-to-r from-orange-50 via-amber-50 to-yellow-50 dark:from-orange-900/20 dark:via-amber-900/20 dark:to-yellow-900/20 border border-orange-200/50 dark:border-orange-700/50 shadow-lg overflow-hidden'>
              {/* 装饰背景 */}
              <div className='absolute inset-0 bg-gradient-to-br from-orange-100/20 to-yellow-100/20 dark:from-orange-800/10 dark:to-yellow-800/10'></div>
